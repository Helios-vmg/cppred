...
public:
	...
	virtual CppRed::actor_ptr<CppRed::Actor> create_actor(CppRed::Game &game, Renderer &renderer) const;
...
public:
	...
	CppRed::actor_ptr<CppRed::Actor> create_actor(CppRed::Game &game, Renderer &renderer) const override;
};
