...
const byte_t character_map_forward[] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0xBB, 0xBC, 0xBD, 0xBE,
	0xBF, 0xE4, 0xE5, 0xF5, 0xEF, 0xF2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00,
	0xE0, 0x9A, 0x9B, 0x00, 0x00, 0xF4, 0xE3, 0xE8, 0xF3, 0xF6, 0xF7, 0xF8, 0xF9,
	0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0xFF, 0x9C, 0x9D, 0x00, 0x00, 0x00, 0xE6, 0x00,
	...
	0x9E, 0x00, 0x9F, 0x00, 0x00, 0x00, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0xA6,
	0xA7, 0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xAE, 0xAF, 0xB0, 0xB1, 0xB2, 0xB3,
	0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const byte_t character_map_reverse[] = {
	...
	,
...
void CppRedText::text_command_processor(const Region &text, const tilemap_it &it){
	...
	byte_t old_flags = wram.wLetterPrintingDelayFlags.get_raw_value();
	wram.wLetterPrintingDelayFlags.set_raw_value(this->parent->hram.hPokedexTextFlags.get_raw_value());
	this->parent->wram.wTextDest = it.address();
	this->place_string(it, text);
	wram.wLetterPrintingDelayFlags.set_raw_value(old_flags);
}
...
void CppRedText::special_character_processor_rival(tilemap_it &it){
	this->process_raw_text(this->parent->wram.wRivalName.to_string(), it, true);
}
...
void CppRedText::print_letter_delay(){
	...
	if (wram.wd730.get_no_print_delay() || !wram.wLetterPrintingDelayFlags.get_delay_enable())
		return;

	unsigned frame_counter;
	if (wram.wLetterPrintingDelayFlags.get_long_delay_enable())
		frame_counter = (unsigned)wram.wOptions.get_text_speed();
	else
		frame_counter = 1;
